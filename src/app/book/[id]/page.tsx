        ...
        <div className="flex flex-col justify-center">
          ...
          <div className="flex items-center space-x-4 mb-6">
            ...
            <div className="flex items-center gap-2">
              ...
              <span className="px-4 py-2 border border-gray-300 rounded-md text-lg bg-white">
                {quantity}
              </span>
              <button
                type="button"
                onClick={handleIncrease}
                className="px-3 py-2 bg-gray-200 rounded-md text-lg font-bold hover:bg-gray-300 transition-colors"
          ...
          <button
            ...
            className="w-full bg-blue-600 text-white py-3 rounded-md hover:bg-blue-700 transition-colors duration-300 text-lg font-semibold cursor-pointer"
          >
            Add to Cart
          </button>
        </div>
