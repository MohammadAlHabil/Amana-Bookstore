...
export const books: Book[] = [
  ...
  },
  {
    ...
    author: 'Group 2',
    description:
      'A comprehensive guide to data science fundamentals, statistical analysis, machine learning algorithms, and practical applications in business and research.',
    price: 89.99,
    image: '/images/book1.jpg',
    isbn: '978-4678901234',
    ...
    pages: 456,
    language: 'English',
    publisher: 'Al-Khwarizmi Data Institute',
    rating: 4.7,
    reviewCount: 24,
    inStock: true,
    featured: true,
